...
#profile_Q = []
#while count>0:
#    profile_Q.extend(driver.find_elements_by_xpath('//span[@class = "name actor-name"]'))
...
page_no = '1'
driver.get(base_url + query + '&page=' + page_no )
...
while profile_list:
    ...
    fillSheet(next_available_row(sheet), query)
